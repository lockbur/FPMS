...
//             if(iter.getSheetName().equals(this.getSheetName())){
...
//        }
    ...
    public void dealDataType(Attributes attributes){
        ...
        if ("b".equals(cellType))
            ...
            }else if(this.formatString.indexOf("h:mm:ss")>0){
    ...
    public static void main(String[] args) throws Exception {
      ...
      //excel.setPath("F:/中行积假.xlsx");
      File file =new File("C:/Documents and Settings/linbc/桌面/新建 Microsoft Office Excel 工作表.xlsx");
        excel.process(new FileInputStream(file));
