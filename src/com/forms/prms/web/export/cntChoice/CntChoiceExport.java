package com.forms.prms.web.export.cntChoice;
...
public class CntChoiceExport implements IExportDataDeal{

	CntChoiceService es = CntChoiceService.getInstance();
	...
	public void getSimpleExcelData(String taskId, Map params,
		...
		// //插入excel数据内容
		try {
			List<CntDevice> projects = new ArrayList<CntDevice>();
			projects = es.exportExcute(batchNo);
