package com.forms.prms.web.export.fndwrr;
...
public class FndwrrExport implements IExportDataDeal{

	OrgReQueryService es = OrgReQueryService.getInstance();
	...
	public void getSimpleExcelData(String taskId, Map params,
		...
		// 获取方法调用的接收参数
 		...
 		String org1Name = (String) params.get("or1Name");
 		String org2Code = (String) params.get("org2Code");
 		String org2Name = (String) params.get("org2Name");
 		String dutyCode = (String) params.get("dutyCode");
 		String dutyName = (String) params.get("dutyName");
 		String isLocked = (String) params.get("isLocked"); 
 		String isSuperAdmin = (String) params.get("isSuperAdmin");
 		String org1CheckCode = (String) params.get("org1CheckCode");
 		String org2CheckCode = (String) params.get("org2CheckCode");
 		...
 		bean.setOrg2Name(org2Name);
 		bean.setDutyCode(dutyCode);
 		bean.setDutyName(dutyName);
 		bean.setIsLocked(isLocked);
 		bean.setIsSuperAdmin(isSuperAdmin);
 		bean.setOrg1CheckCode(org1CheckCode);
 		bean.setOrg2CheckCode(org2CheckCode);
		// //插入excel数据内容
		try {
			List<OrgReQueryBean> projects = new ArrayList<OrgReQueryBean>();
