package com.forms.prms.web.export.proj;
...
public class ProjExport implements IExportDataDeal{

	ProjectMgrService es = ProjectMgrService.getInstance();
	...
	public void getSimpleExcelData(String taskId, Map params,
		...
		String dutyCode = (String) params.get("dutyCode");
 		...
 		String projType = (String) params.get("projType");
		...
		bean.setuOrg1Code(org1Code);
		bean.setuOrg2Code(org2Code);
