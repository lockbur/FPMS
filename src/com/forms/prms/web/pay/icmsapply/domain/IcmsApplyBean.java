package com.forms.prms.web.pay.icmsapply.domain;
 ...
 * 影像编辑申请Bean
 */
public class IcmsApplyBean implements Serializable {
	...
	private String icmsEdit;//影像编辑状态
	
	private String newIcmsEdit;//更新后影响编辑状态
	...
	public String getNewIcmsEdit() {
		return newIcmsEdit;
	}

	public void setNewIcmsEdit(String newIcmsEdit) {
		this.newIcmsEdit = newIcmsEdit;
	}
