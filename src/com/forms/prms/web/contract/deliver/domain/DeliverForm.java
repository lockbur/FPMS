package com.forms.prms.web.contract.deliver.domain;

import com.forms.prms.web.contract.initiate.domain.ContractBean;

public class DeliverForm extends ContractBean {
	...
	private String cntNumCancel;

	public String getCntNumCancel() {
		return cntNumCancel;
	}

	public void setCntNumCancel(String cntNumCancel) {
		this.cntNumCancel = cntNumCancel;
	}
