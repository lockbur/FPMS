package com.forms.prms.web.cleanpaydeal.cleanpay.domain;

import java.io.Serializable;
import java.math.BigDecimal;

public class CleanPayBean implements Serializable {
	...
	private BigDecimal uncleanAmt;//未结清金额（本次核销前暂收金额）
	
	private BigDecimal befcleanAmt;//未结清金额（本次核销前暂收金额）
	
	private String befDate;// 付款日期
	private String aftDate;// 付款日期

	private String flag;// 返回标识符
	
	private String buttonFlag; //按钮参数标识
	...
	public BigDecimal getBefcleanAmt() {
		return befcleanAmt;
	}

	public void setBefcleanAmt(BigDecimal befcleanAmt) {
		this.befcleanAmt = befcleanAmt;
	}
