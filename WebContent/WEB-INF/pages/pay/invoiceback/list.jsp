...
function showDetail(payId,isPrePay,cntNum,isCreditNote,invoiceIdBlue){
	...
	$("#queryDetailForm #invoiceIdBlue1").val(invoiceIdBlue);
 	form.attr('action', '<%=request.getContextPath()%>/pay/invoiceback/detail.do?<%=WebConsts.FUNC_ID_KEY%>=0303090201');
	App.submit(form);
}
function doValidate(){
	...
	<table id="condition">
		...
		<tr>
			<td colspan="4" class="tdWhite">
				<p:button funcId="03030902" value="查询"/> 
			 ...
			 <c:forEach items="${list}" var="sedList">
				<tr onmouseover="setTrBgClass(this, 'trOnOver2');" onmouseout="setTrBgClass(this, 'trOther');">
					...
					<td>
						...
						<td>
							<div class="update">
								<a href="#" onclick="showDetail('${sedList.payId}','${sedList.isPrePay}','${sedList.cntNum}','${sedList.isCreditNote}','${sedList.invoiceIdBlue}')" title="处理"></a>
							</div>
						</td>
				</tr>
			</c:forEach>
