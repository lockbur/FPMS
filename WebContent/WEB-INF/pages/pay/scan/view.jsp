...
<script language="javascript">
       ...
       function setsys()
       {
           ...
           str += "<Info>";
			//actionFlag控件状态
           str += "<actionFlag>02</actionFlag>";			//uploadIp上传消息服务器IP、upload_port上传消息服务器端口、download_ip下载消息服务器IP、download_port下载消息服务器端口（uploadIp、upload_port、download_ip、download_port为必填项）
           ...
           //systemId系统编号、buttonVisible控件按钮的显示情况、AnnEdit是否包含批注功能
			str += "<systemId>${scanConfig.systemId}</systemId><buttonVisible>00000000000000</buttonVisible><AnnEdit>1</AnnEdit>";
           str += "<businessId>${payId}</businessId><DownloadContent>1</DownloadContent><DownloadAll>0</DownloadAll>";//2232 QPC21804
	...
	//设置文档类型树的树型目录结构
       ...
       { 
          var str = "<?xml version=\"1.0\" encoding=\"utf-8\" ?>";
           ...
           str += "<item itemcode=\"99\" itemdesc=\"付款文件\" parentcode=\"100\" data_type=\"${scanConfig.dataType}\"   compound=\"1\" TemplateName=\"doc2\" pkuuid=\"${pkuuid}\"/>";
           /*
