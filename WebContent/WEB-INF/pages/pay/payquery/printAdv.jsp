...
{
	<%--
	var flag = $.checkPlugins('ReportViewProj','ReportViewProj.ReportViewX');
	if(flag){
		$("#isHide").hide();
...
<table width="100%" height="100%" border="0">
	<tr>
		<td height="100%"><object id="ReportX1" name="ReportX1" on
			classid="clsid:E5B15231-0C29-449B-AD12-B4A7382F6BDA" width="100%"
			height="100%" align=middle hspace=0 vspace=0> </object></td>
	</tr>
</table>
<br/>
