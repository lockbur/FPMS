...
function confirm(){
	...
	App.ajaxSubmit("pay/payAdd/cancel.do?<%=WebConsts.FUNC_ID_KEY %>=03030327",{
...
<table id="cancelTable" class="tableList">
	...
	<c:forEach items="${devices}" var="bean">
		<tr>
			...
			<input id="advancePayInvAmts" onkeyup="$.clearNoNum(this);" onblur="checkAdvPayIvrowMemos(this);countTotal('advancePayInvAmts','advanceCancelAmtTotalSpan');$.onBlurReplace(this);" name="advancePayInvAmts" value="${bean.subInvoiceAmt }" maxlength="18"  class="base-input-text" style="width: 100px;" valid errorMsg="请输入预付款设备发票分配金额"/>
			</td>
