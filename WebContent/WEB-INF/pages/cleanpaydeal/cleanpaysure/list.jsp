...
function showDetail(cleanPayId,payId,cntNum)
{
	...
	form.action = "<%=request.getContextPath()%>/cleanpaydeal/cleanpaysure/detail.do?<%=WebConsts.FUNC_ID_KEY %>=03050402&cleanPayId="+cleanPayId+"&payId="+payId+"&cntNum="+cntNum;
...
<form action="" method="post" id="cleanForm">
	<table>
		...
		<tr>
			...
			<td class="tdRight">
				<input type="text" id="befDate" name="befDate"  maxlength='10' readonly="readonly" value="${selectInfo.befDate}" class="base-input-text" style="width:145px;"/>
				至
				<input type="text" id="aftDate" name="aftDate"  maxlength='10' readonly="readonly" value="${selectInfo.aftDate}" class="base-input-text" style="width:145px;"/>
			</td>
		...
		<tr>
			<td colspan="4">
				<p:button funcId="03050401" type="search"/>
		...
		<c:if test="${!empty list}">
			<c:forEach items="${list}" var="bean">
				<tr onmouseover="setTrBgClass(this, 'trOnOver2');" onmouseout="setTrBgClass(this, 'trOther');">
					...
					<td>
						<div class="update">
							<a href="#" onclick="showDetail('${bean.cleanPayId}','${bean.normalPayId}','${bean.cntNum}');" title="确认"></a>
						</div>
