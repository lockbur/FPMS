...
//暂收结清处理
function cleanpayDeal(payId,cntNum)
{
	var form = $("#cleanDealForm")[0];
	form.action = "<%=request.getContextPath()%>/cleanpaydeal/cleanpay/queryCleanPayDeal.do?<%=WebConsts.FUNC_ID_KEY %>=03050101&normalPayId="+payId+"&cntNum="+cntNum;
...
<form action="" method="post" id="cleanForm">
	<table>
		...
		<tr>
			...
			<td class="tdRight" >
				<input type="text" id="befDate" name="befDate"  maxlength='10' readonly="readonly" value="${selectInfo.befDate}" class="base-input-text" style="width:35%;"/>至
		...
		<tr>
			<td class="tdWhite" colspan="4">
				<p:button funcId="030501" value="查找"/>
			...
			<c:forEach items="${cleanpayList}" var="bean">
				<tr onmouseover="setTrBgClass(this, 'trOnOver2');" onmouseout="setTrBgClass(this, 'trOther');">
					...
					<td>
						...
						<div class="update">
							<a href="#" onclick="cleanpayDeal('${bean.payId}','${bean.cntNum}');" title="暂收结清"></a>
						</div>
