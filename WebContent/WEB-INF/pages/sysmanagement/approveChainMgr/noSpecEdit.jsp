...
<body>
<p:authFunc funcArray="0812010303"/>
...
<p:token/>
	<table id="approveChainTable">
		...
		<tr>
			...
			<td class="tdRight">
				<forms:OrgSelPlugin suffix="s1" rootLevel="1" rootNodeId="${bean.org1Code}" initValue="${bean.matrBuyDept}" jsVarGetValue="matrBuyDept" parentCheckFlag="false"/>
				
			</td>
			<td class="tdLeft">物料归口部门<span style="color: #A41E1E">*</span></td>
			<td class="tdRight">
				<forms:OrgSelPlugin suffix="s2" rootLevel="1" rootNodeId="${bean.org1Code}" initValue="${bean.matrAuditDept}" jsVarGetValue="updateMatrAuditDept" parentCheckFlag="false"/>
		...
		<tr>
			...
			<td class="tdRight">
				<forms:OrgSelPlugin suffix="s3" rootLevel="1" rootNodeId="${bean.org1Code}" initValue="${bean.fincDeptS}" jsVarGetValue="fincDeptS" parentCheckFlag="false"/>
				
			</td>
			<td class="tdLeft">二级分行财务管理部门<span style="color: #A41E1E">*</span></td>
			<td class="tdRight">
				<forms:OrgSelPlugin suffix="s4" rootLevel="1" rootNodeId="${bean.org1Code}" initValue="${bean.fincDept2}" jsVarGetValue="fincDept2" parentCheckFlag="false"/>
			<!-- 
					...
					<forms:OrgSelPlugin   suffix="005" triggerEle="#approveChainTable tr fincDept2Name,fincDept2::name,id" rootNodeId="${bean.org1Code}" 
							rootLevel="1" initValue="${bean.fincDept2}"  parentCheckFlag="false"  jsVarName="fincDept2Tree"  />
			-->
			</td>
		</tr>
		<tr>
			...
			<td class="tdRight"  >
				<forms:OrgSelPlugin suffix="s5" rootLevel="1" rootNodeId="${bean.org1Code}" initValue="${bean.fincDept1}" jsVarGetValue="fincDept1" parentCheckFlag="false"/>
				
			</td>
			<td class="tdLeft">预算分解部门<span style="color: #A41E1E">*</span></td>
			<td class="tdRight" colspan="3">
				<forms:OrgSelPlugin suffix="s6" rootLevel="1" rootNodeId="${bean.org1Code}" initValue="${bean.decomposeOrg}" jsVarGetValue="decomposeOrg" parentCheckFlag="false"/>
		...
		<tr>
			<td colspan="4" class="tdWhite">
				    <p:button funcId="0812010303" value="提交"/>
