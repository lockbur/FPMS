...
<form action="<%=request.getContextPath()%>/sysmanagement/referencespecial/referenceAdd.do" method="post" id="rForm">
	...
	<table>
		...
		<tr>
			...
			<td class="tdRight" width="50%">${bean.referenceId}
				<input type="hidden" id="referenceId" name="referenceId" value="${bean.referenceId}" class="base-input-text" maxlength="7" readonly="readonly"/>	
			</td>
		</tr>
		<tr>
			<td class="tdLeft"><span class="red">*</span>参考说明</td>
			<td class="tdRight">
				<input type="text" id="referenceName" name="referenceName" value="${bean.referenceName}" valid class="base-input-text" maxlength="200"/>	
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2" class="tdWhite">
				<p:button funcId="01120105" value="更新"/>
