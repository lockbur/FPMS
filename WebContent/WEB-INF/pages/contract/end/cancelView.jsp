...
function toEnd(cntNum){
	//终止
	var data = {};
	data['cntNum'] = cntNum;
	App.ajaxSubmit("contract/end/checkToEnd.do?<%=WebConsts.FUNC_ID_KEY %>=0302070101",
			...
			$("#auditDiv").dialog({
				...
				buttons: {
					"确定": function() {
						...
						var url = "<%=request.getContextPath()%>/contract/end/cancel.do?<%=WebConsts.FUNC_ID_KEY %>=0302070102";
...
<%-- 										<td><fmt:formatNumber type="number" value="${dzspItem.abcdeAmt}"/></td> --%>
		...
		<tr>
			<td colspan="4" >
				...
				<input type="button" value="合同取消" onclick="toEnd('${cnt.cntNum}');"> 
...
<jsp:include page="cancelAudit.jsp" />
</body>
</html>