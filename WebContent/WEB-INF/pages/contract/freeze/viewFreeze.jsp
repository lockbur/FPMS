...
function toFreeze(cntNum){
	//终止
	var url = "<%=request.getContextPath()%>/contract/freeze/freeze.do?<%=WebConsts.FUNC_ID_KEY %>=0302050102";
	$("#auditDiv").dialog({
		title:"冻结",
		closeOnEscape:false,
		autoOpen: true,
...
<%-- 										<td><fmt:formatNumber type="number" value="${dzspItem.abcdeAmt}"/></td> --%>
			...
			<td>
				...
				<tr class="collspan-control">
					...
					<tr>
						...
						<td class="tdRight" colspan="3">${cnt.autoBankName}</td> --%>
						<td class="tdLeft">房产(项目)性质</td>
		...
		<tr>
			<td colspan="4" >
				...
				<input type="button" value="冻结" onclick="toFreeze('${cnt.cntNum}');"> 
