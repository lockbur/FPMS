...
*/
  	...
  	<script language="Javascript" event="OnSave()" for="ContentMain">
		...
		if(docSize==0){
			...
			var url = "common/contract/scan/update.do?<%=WebConsts.FUNC_ID_KEY %>=03020107";
			App.ajaxSubmitForm(url, $("#scanForm"),  
		    		function(data){
						ret = true;
						alert("上传并保存成功!");
						//DisposeControl();
...
<form action="<%=request.getContextPath()%>/contract/initiate/scansave.do?<%=WebConsts.FUNC_ID_KEY %>=03020107" method="post" id="scanForm">
<p:token/>
