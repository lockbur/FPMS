				   ...
				   <td >
					   <div class="tab_gray" id="td_0" style="float: left;">
							...
							<div class="tab_middle">
								 <a href="<%=request.getContextPath()%>/contract/query/cntDtl.do?<%=WebConsts.FUNC_ID_KEY %>=03020601&cntNum=${param.cntNum}" target="module" style="text-decoration: none;"  onclick="change(this);" name="hrefName" id="href_0">合同信息</a>
							</div>
						...
						<div class="tab_gray" id="td_1" style="float: left;">
							<div class="tab_left"></div>
							<div class="tab_middle">
								<a href="<%=request.getContextPath()%>/pay/payquery/list.do?<%=WebConsts.FUNC_ID_KEY %>=03020607&cntNum=${param.cntNum}&fromFlag=contract" target="module" style="text-decoration: none;"  onclick="change(this);" name="hrefName" id="href_1">付款信息</a>
							</div>
							<div class="tab_right"></div>
						</div>
						<c:if test="${cnt.isOrder == '0'}">
						<div class="tab_gray" id="td_2" style="float: left;">
							<div class="tab_left"></div>
							<div class="tab_middle">
								<a href="<%=request.getContextPath()%>/contract/query/queryOrder.do?<%=WebConsts.FUNC_ID_KEY %>=03020605&cntNum=${param.cntNum}&flag=0" target="module" style="text-decoration: none;"  onclick="change(this);" name="hrefName" id="href_2">订单信息</a>
							</div>
							<div class="tab_right"></div>
						</div>
						</c:if>
	...
	<tr>
		<td>			
			<iframe id="module" name="module" frameborder="0"  width="100%" scrolling="no" onload="iframeOnloadHeight(this);" 
				src="<%=request.getContextPath()%>/contract/query/cntDtl.do?<%=WebConsts.FUNC_ID_KEY %>=03020601&cntNum=${param.cntNum}"></iframe>
		</td>	
	</tr>
</table>	
