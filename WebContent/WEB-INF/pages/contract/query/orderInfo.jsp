	         ...
	         <td>
	         	<table class="tableList">
					...
					<c:forEach items="${devList}" var="sedList">
						...
						<td>${sedList.taxCode }</td>
						<td>
							<fmt:formatNumber type="number" value="${sedList.cntTrAmt}" minFractionDigits="2"/>
						</td>
						<td>
							<fmt:formatNumber type="number" value="${sedList.execPrice}" minFractionDigits="2"/>
						</td>
						<td>
...
<%-- 				<input type="button" value="查询订单审批历史记录" onclick="queryHis('${orderInfo.orderId}');"> --%>
