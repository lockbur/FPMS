...
//二级行汇总
function budgetTmpSecLvlSum(tmpltId){
	var form = $("#budgetForm")[0];
	form.action="<%=request.getContextPath()%>/budget/finandeptsum/secondList.do?<%=WebConsts.FUNC_ID_KEY %>=02040201&tmpltId=" + tmpltId;
	App.submit(form);
}
...
<body>
<p:authFunc funcArray="020402,02040201"/>
	...
	<table id="approveChainTable">
		...
		<tr>
			<td colspan="4" class="tdWhite">
					<p:button funcId="020402"  value="查找" />
			...
			<c:forEach items="${budgetTmpList}" var="budget" varStatus="status">
				<tr onmouseover="setTrBgClass(this, 'trOnOver2');" onmouseout="setTrBgClass(this, 'trOther');">				
					...
					<td style="text-align: center;vertical-align: middle">
						<input type="button" value="二级汇总" onclick="budgetTmpSecLvlSum('${budget.tmpltId}');"/>
