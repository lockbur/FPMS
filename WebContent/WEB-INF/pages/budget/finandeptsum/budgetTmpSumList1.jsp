...
//一级行汇总
function budgetTmpFirLvlSum(tmpltId){
	var form = $("#budgetForm")[0];
	form.action="<%=request.getContextPath()%>/budget/finandeptsum/firstList.do?<%=WebConsts.FUNC_ID_KEY %>=02040301&tmpltId=" + tmpltId;
	App.submit(form);
}
...
<body>
<p:authFunc funcArray="020403,02040301"/>
	...
	<table id="approveChainTable">
		...
		<tr>
			<td colspan="4" class="tdWhite">
					<p:button funcId="020403"  value="查找" />
			...
			<c:forEach items="${budgetTmpList}" var="budget" varStatus="status">
				<tr onmouseover="setTrBgClass(this, 'trOnOver2');" onmouseout="setTrBgClass(this, 'trOther');">				
					...
					<td style="text-align: center;vertical-align: middle">
						<input type="button" value="一级汇总" onclick="budgetTmpFirLvlSum('${budget.tmpltId}');"/>
